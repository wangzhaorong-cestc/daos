...
type PoolQueryReq struct {
	...
	Sys      string   `protobuf:"bytes,1,opt,name=sys,proto3" json:"sys,omitempty"`                                   // DAOS system identifier
	SvcRanks []uint32 `protobuf:"varint,3,rep,packed,name=svc_ranks,json=svcRanks,proto3" json:"svc_ranks,omitempty"` // list of pool service ranks
	Uuids    []string `protobuf:"bytes,4,rep,name=uuids,proto3" json:"uuids,omitempty"`                               // list of pool identifiers
}
...
func (x *PoolQueryReq) GetUuids() []string {
	if x != nil {
		return x.Uuids
	}
	return nil
...
func (*PoolQueryResp_Pool) Descriptor() ([]byte, []int) {
	return file_mgmt_pool_proto_rawDescGZIP(), []int{21, 0}
}
...
var file_mgmt_pool_proto_rawDesc = []byte{
	...
	0x75, 0x75, 0x69, 0x64, 0x22, 0x5d, 0x0a, 0x0c, 0x50, 0x6f, 0x6f, 0x6c, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x79, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x73, 0x79, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x76, 0x63, 0x5f, 0x72, 0x61,
	0x6e, 0x6b, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x08, 0x73, 0x76, 0x63, 0x52, 0x61,
	0x6e, 0x6b, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x75, 0x75, 0x69, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x05, 0x75, 0x75, 0x69, 0x64, 0x73, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x52,
	0x02, 0x69, 0x64, 0x22, 0x94, 0x01, 0x0a, 0x11, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x55,
	...
	0x0a, 0x04, 0x42, 0x55, 0x53, 0x59, 0x10, 0x02, 0x22, 0xdd, 0x03, 0x0a, 0x0d, 0x50, 0x6f, 0x6f,
	...
	0x75, 0x73, 0x12, 0x2e, 0x0a, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x18, 0x2e, 0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x50, 0x6f, 0x6f, 0x6c, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x2e, 0x50, 0x6f, 0x6f, 0x6c, 0x52, 0x05, 0x70, 0x6f, 0x6f,
	0x6c, 0x73, 0x1a, 0xfd, 0x02, 0x0a, 0x04, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61,
	...
	0x65, 0x72, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x0c, 0x22, 0x63, 0x0a, 0x0c, 0x50, 0x6f, 0x6f, 0x6c,
	...
	0x69, 0x65, 0x73, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_mgmt_pool_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_mgmt_pool_proto_goTypes = []interface{}{
	...
	(*PoolQueryResp_Pool)(nil),   // 30: mgmt.PoolQueryResp.Pool
}
var file_mgmt_pool_proto_depIdxs = []int32{
	...
	30, // 4: mgmt.PoolQueryResp.pools:type_name -> mgmt.PoolQueryResp.Pool
	23, // 5: mgmt.PoolSetPropReq.properties:type_name -> mgmt.PoolProperty
	23, // 6: mgmt.PoolGetPropReq.properties:type_name -> mgmt.PoolProperty
	23, // 7: mgmt.PoolGetPropResp.properties:type_name -> mgmt.PoolProperty
	21, // 8: mgmt.PoolQueryResp.Pool.rebuild:type_name -> mgmt.PoolRebuildStatus
	20, // 9: mgmt.PoolQueryResp.Pool.tier_stats:type_name -> mgmt.StorageUsageStats
